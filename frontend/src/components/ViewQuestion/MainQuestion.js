            ...
            <div className="question-answer">
              ...
              <div className="author">
                ...
                <div className="auth-details">
                  <Avatar {...stringAvatar(questionData?.user?.username)} />
                  <p>
                   {questionData && questionData.user.username}
                  </p>
                </div>
              </div>
              ...
              {questionData?.comments &&
                  questionData.comments.map((_qd) => {
                    console.log("_qd:", _qd); // 👈 print to browser dev console ... you loop here because of index it will go to each index and print data
                    return (
                      <p key={_qd?._id}>
                        {_qd?.comment}{" "}
                        <span>
              ...
              >
                ...
                <div className="question-answer">
                  ...
                  <div className="author">
                    ...
                    <div className="auth-details">
                      <Avatar {...stringAvatar(_q?.user?.username)} />  
                      <p>
                      {_q?.user?.username} 
                      </p>
                    </div>
